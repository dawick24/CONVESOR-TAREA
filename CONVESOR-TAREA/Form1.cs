        ...
        {
            {
                ...
                cboDeConversor.Items.AddRange(TipoDeConversores[cboTipoConversor.SelectedIndex]);


                cboAConversor.Items.Clear();
                cboAConversor.Items.AddRange(TipoDeConversores[cboTipoConversor.SelectedIndex]);
